...
\begin{center}
	\begin{minipage}{0.8\textwidth}
			...
			We construct a neural-based multi-agent system, consisting of: neural networks named Alice and Bob who act as sender and receiver respectively, an unknown malicious adversary which is a neural network named Alan, a known helpful adversary which is a neural network named Eve, with the fact that both adversaries have access to the information channel between Alice and Bob, and thus acting as eavesdroppers. 
